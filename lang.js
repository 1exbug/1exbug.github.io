...
cards:{slots:{title:"Authentication & account logic",text:"Authentication, session and account-control issues documented across the application."},onx:{title:"Authorization & business logic",text:"KYC, payout, balance, race-condition and WebSocket access-control findings."},zooma:{title:"Responsible disclosure",text:"Race conditions, IDOR, XSS and token-exposure issues reported through a responsible disclosure channel.",deadlineLabel:"Response deadline:",deadline:"October 6, 2026",statusLabel:"Status:",status:"Awaiting response",notice:"If no response is received by the date above, technical details will be published in accordance with standard responsible disclosure practice."}},
read:"Read write-up",
...
cards:{slots:{title:"Аутентификация и аккаунт",text:"Задокументированные проблемы аутентификации, сессий и управления аккаунтом."},onx:{title:"Контроль доступа и бизнес-логика",text:"Находки в KYC, выплатах, балансах, race condition и WebSocket-доступе."},zooma:{title:"Ответственное раскрытие",text:"Race condition, IDOR, XSS и проблемы с токенами переданы через канал ответственного раскрытия.",deadlineLabel:"Дедлайн ответа:",deadline:"6 октября 2026",statusLabel:"Статус:",status:"Ожидает ответа",notice:"Если ответа не последует до указанной даты, технические детали будут опубликованы в соответствии со стандартной практикой ответственного раскрытия."}},
