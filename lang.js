...
cards:{slots:{title:"Аутентификация и аккаунт",text:"Задокументированные проблемы аутентификации, сессий и управления аккаунтом."},onx:{title:"Контроль доступа и бизнес-логика",text:"Находки в KYC, выплатах, балансах, race condition и WebSocket-доступе."},zooma:{title:"Ответственное раскрытие",text:"Race condition, IDOR, XSS и проблемы с токенами переданы через канал ответственного раскрытия.",statusLabel:"Статус:",status:"Ответ получен",rewardLabel:"Награда:",reward:"15 000 ₽",result:"Zooma подтвердила XSS через winnerName в розыгрышах и сообщила о готовности выплатить 15 000 ₽.",position:"По остальным пунктам Zooma указала, что подмена userID не даёт доступа к чужим данным, verify-раунды публичны, seed раскрывается только после завершения раунда, а Centrifugo JWT является клиентским connection token."}},
