...
cards:{slots:{title:"Authentication & account logic",text:"Authentication, session and account-control issues documented across the application."},onx:{title:"Authorization & business logic",text:"KYC, payout, balance, race-condition and WebSocket access-control findings."},zooma:{title:"Responsible disclosure",text:"Race conditions, IDOR, XSS and token-exposure issues reported through a responsible disclosure channel.",statusLabel:"Status:",status:"Response received",rewardLabel:"Bounty:",reward:"15,000 RUB",permissionLabel:"Research authorization:",permission:"received 23.09.2026",bountyLabel:"Bug bounty program:",bounty:"none, payments handled individually",result:"Zooma confirmed the XSS via winnerName in giveaways and stated that it is ready to pay 15,000 RUB.",position:"For the other reported items, Zooma stated that changing userID does not provide access to other users' data, verify rounds are public, the seed is disclosed only after a round is completed, and the Centrifugo JWT is the current user's client connection token."}},ezcash:{title:"Security findings",text:"Two vulnerabilities reported through the support channel. Response and reward status are pending.",findingsLabel:"Findings discovered:",findings:"2",confirmedLabel:"Confirmed:",confirmed:"awaiting response",paidLabel:"Paid:",paid:"awaiting response",dateLabel:"Report date:",date:"25.09.2026",channelLabel:"Submission channel:",channel:"support@ezcash.casino",accountLabel:"Researcher account ID:",account:"sub = 2451160"}},
read:"Read write-up",
targets:{title:"Research surface.",target:"Target",state:"State",pending:"disclosure",responded:"response received"},
...
cards:{slots:{title:"Аутентификация и аккаунт",text:"Задокументированные проблемы аутентификации, сессий и управления аккаунтом."},onx:{title:"Контроль доступа и бизнес-логика",text:"Находки в KYC, выплатах, балансах, race condition и WebSocket-доступе."},zooma:{title:"Ответственное раскрытие",text:"Race condition, IDOR, XSS и проблемы с токенами переданы через канал ответственного раскрытия.",statusLabel:"Статус:",status:"Ответ получен",rewardLabel:"Награда:",reward:"15 000 ₽",permissionLabel:"Разрешение на исследование:",permission:"получено 23.09.2026",bountyLabel:"Bug bounty программа:",bounty:"отсутствует, выплаты в индивидуальном порядке",result:"Zooma подтвердила XSS через winnerName в розыгрышах и сообщила о готовности выплатить 15 000 ₽.",position:"По остальным пунктам Zooma указала, что подмена userID не даёт доступа к чужим данным, verify-раунды публичны, seed раскрывается только после завершения раунда, а Centrifugo JWT является клиентским connection token."}},ezcash:{title:"Находки безопасности",text:"Две уязвимости переданы через канал поддержки. Ответ и информация о выплате пока ожидаются.",findingsLabel:"Обнаружено уязвимостей:",findings:"2",confirmedLabel:"Подтверждено:",confirmed:"ожидает ответа",paidLabel:"Выплачено:",paid:"ожидает ответа",dateLabel:"Дата отчёта:",date:"25.09.2026",channelLabel:"Канал отправки:",channel:"support@ezcash.casino",accountLabel:"ID аккаунта исследователя:",account:"sub = 2451160"}},
read:"Читать write-up",
targets:{title:"Поверхность исследования.",target:"Цель",state:"Статус",pending:"раскрытие",responded:"ответ получен"},
